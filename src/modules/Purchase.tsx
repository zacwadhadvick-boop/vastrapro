...
export default function Purchase({
  ...
  const [showTransportSlip, setShowTransportSlip] = useState<string | null>(
    null,
  );
  const billRef = React.useRef<HTMLDivElement>(null);

  const selectedBill =
    state.purchaseInvoices.find((p) => p.id === selectedBillId) ||
    state.purchaseInvoices[0];
  const selectedSupplier = state.suppliers.find(
    (s) => s.id === selectedBill?.supplierId,
  );

  const viewBill = (id: string, printAfter = false) => {
  ...
  const filteredPurchases = state.purchaseInvoices.filter(
    (p) =>
    ...
    <div className="space-y-12 pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 px-2 no-print">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h3 className="font-black text-slate-800 uppercase tracking-widest text-lg">
              Inventory Inward
            </h3>
            <p className="text-[10px] text-slate-400 font-black uppercase tracking-[0.2em] mt-0.5">
              Supply Chain & Purchase Ledger
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-8 print:block">
        {activeTab === "registry" ? (
          <div className="xl:col-span-3">
            <div className="bg-white rounded-[3.5rem] shadow-sm border border-slate-50 overflow-hidden p-8 md:p-12">
              <div className="hidden print:block mb-8">
                <ReportHeader />
                <h2 className="text-2xl font-black text-slate-900 uppercase tracking-widest text-center my-6">
                  Inward Purchase Registry
                </h2>
              </div>
              <div className="flex items-center justify-between mb-8 no-print">
                <div>
                  ...
                  <p className="text-[10px] text-slate-400 font-bold uppercase mt-1">
                    Audit trail of all incoming goods
                  </p>
                </div>
                <button
                      ...
                      filteredPurchases.map((p) => (
                        ...
                        >
                          ...
                          <td className="px-8 py-6 text-slate-500 font-black text-[11px] uppercase tracking-tighter">
                            {state.suppliers.find((s) => s.id === p.supplierId)
                              ?.name || p.supplierId}
                          </td>
                          <td className="px-8 py-6 text-slate-300 text-[10px] font-black uppercase">
          ...
          <div className="xl:col-span-3 bg-slate-100/50 p-10 rounded-[3rem] border border-slate-200 shadow-inner min-h-[900px] print:bg-white print:p-0 print:border-none print:shadow-none">
            <div className="max-w-7xl mx-auto space-y-6" ref={billRef}>
              {!selectedBill ? (
                <div className="flex flex-col items-center justify-center py-40 text-slate-400 space-y-6">
                  ...
                  <p className="font-black uppercase tracking-[0.3em] text-[10px]">
                    Select a bill from registry to view details
                  </p>
                  <button
                    onClick={() => setActiveTab("registry")}
                    className="px-8 py-3 bg-primary text-white rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-xl shadow-primary/20"
                  >
                    Go to Registry
                  </button>
                </div>
                    ...
                    <div className="col-span-3 space-y-4">
                      <div className="bg-blue-900 text-white p-6 rounded-3xl shadow-xl space-y-2">
                        ...
                        <h4 className="text-xl font-black italic tracking-tighter uppercase">
                          {selectedBill.entryType || "Purchase Bill"}
                        </h4>
                        <div className="pt-4 flex justify-between items-center border-t border-white/10">
                          <span className="text-[10px] font-black opacity-50 uppercase">
                            Status
                          </span>
                          <span className="bg-green-500 px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest">
                            {selectedBill.statusLabel || "Final"}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start justify-between border-b border-slate-50 pb-6">
                        <div className="space-y-4">
                          ...
                          <div className="grid grid-cols-2 gap-x-12 gap-y-2 text-[11px] font-bold uppercase text-slate-500">
                            ...
                            <div className="flex justify-between">
                              <span>City:</span>{" "}
                              <span className="text-slate-800 text-blue-600">
                                SURAT
                              </span>
                            </div>
                            <div className="flex justify-between">
                    ...
                    <div className="col-span-3 bg-slate-900 p-8 rounded-[2.5rem] text-white shadow-2xl space-y-6">
                      <div className="space-y-1">
                        ...
                        <p className="text-2xl font-black italic tracking-tighter">
                          {format(new Date(selectedBill.date), "dd/MMM/yyyy")}
                        </p>
                      </div>
                      <div className="grid grid-cols-2 gap-4 pt-6 border-t border-white/5 font-black uppercase text-[9px] tracking-widest opacity-40">
                        <div className="space-y-1">
                          <span>Bill No</span>
                          <span className="block text-white text-lg opacity-100">
                            {selectedBill.billNo}
                          </span>
                        </div>
                        <div className="space-y-1">
                      ...
                      <div className="pt-4 border-t border-white/5 space-y-2">
                        <div className="flex justify-between text-[10px] font-black uppercase tracking-widest">
                          ...
                          <span className="text-red-400">
                            {selectedBill.dueOn || "09/Jun/2026"}
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="col-span-12 relative z-10 grid grid-cols-5 gap-8">
                      <div className="space-y-1">
                        ...
                        <p className="text-xs font-black text-slate-800 uppercase">
                          {selectedBill.brokerName || "PRAGYA TEXTILE AGENCIES"}
                        </p>
                      </div>
                      <div className="space-y-1">
                        <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest">
                        ...
                        <p className="text-xs font-black text-slate-800 uppercase">
                          {selectedBill.transporterName ||
                            "MEHTA INTERSTATE TRANSPORT CORP"}
                        </p>
                      </div>
                      <div className="space-y-1">
                        <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-xs font-black text-slate-800">
                          {selectedBill.biltyDate || "15/Apr/2026"}
                        </p>
                      </div>
                      <div className="space-y-1 text-right no-print">
                        <div className="flex gap-2 justify-end">
                          ...
                          <button
                            onClick={() =>
                              setShowTransportSlip(selectedBill.biltyNo)
                            }
                      ...
                      <tbody className="divide-y divide-slate-50 font-black text-xs uppercase text-slate-800 italic tracking-tighter">
                        {selectedBill.items.map((item, idx) => {
                          ...
                          return (
                            ...
                            >
                              <td className="px-10 py-5 text-slate-300 font-bold">
                                {idx + 1}
                              </td>
                              <td className="px-10 py-5">
                                {product?.category || "CATLOG"}
                              </td>
                              <td className="px-10 py-5">
                                {product?.brand || "VARSHNEY ALOK"}
                              </td>
                              <td className="px-10 py-5 text-blue-600">
                                {product?.name || "SUIT SET - 001"}
                              </td>
                    ...
                    <div className="col-span-8 grid grid-cols-4 gap-6 relative z-10">
                      <div className="space-y-4">
                        <div className="bg-white/5 p-4 rounded-2xl border border-white/10">
                          ...
                          <p className="text-xs font-black text-white italic">
                            {selectedBill.items[0]?.barcode || "DSST-13000"}
                          </p>
                        </div>
                        <div className="bg-white/5 p-4 rounded-2xl border border-white/10">
                          <p className="text-[8px] font-black text-white/30 uppercase tracking-widest mb-1">
                      ...
                      <div className="col-span-2 space-y-4">
                        <div className="bg-white/5 p-6 rounded-3xl border border-white/10 flex justify-between items-center">
                          ...
                          <span className="text-2xl font-black text-white italic italic">
                            ₹
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div className="bg-white/5 p-4 rounded-2xl border border-white/10">
                            ...
                            <p className="text-sm font-black text-yellow-400 italic">
                              {(selectedBill.rdAmount || 0).toLocaleString(
                                undefined,
                                { minimumFractionDigits: 2 },
                              )}
                            </p>
                          ...
                          <div className="bg-white/5 p-4 rounded-2xl border border-white/10">
                            ...
                            <p className="text-sm font-black text-red-400 italic">
                              {(
                    ...
                    <div className="col-span-4 space-y-6 relative z-10 border-l border-white/10 pl-10">
                      <div className="space-y-2">
                        <div className="flex justify-between items-center text-[10px] font-black text-white/40 uppercase tracking-[0.2em]">
                          ...
                          <span className="text-white">
                            {(selectedBill.igst || 0).toLocaleString(
                              undefined,
                              { minimumFractionDigits: 2 },
                            )}
                          </span>
                        ...
                        <div className="flex justify-between items-center text-[10px] font-black text-white/40 uppercase tracking-[0.2em]">
                          <span>Round Off</span>
                          <span className="text-white">
                            {(selectedBill.roundOff || 0).toFixed(2)}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="bg-primary/20 p-8 rounded-[2.5rem] border border-primary/30 space-y-2">
                        ...
                        <h3 className="text-4xl font-black text-white italic tracking-tighter">
                          ₹
                          {selectedBill.totalAmount.toLocaleString(undefined, {
                            minimumFractionDigits: 2,
                          })}
                        </h3>
                      </div>
            ...
            <div className="fixed inset-0 z-[60] flex items-center justify-center p-6 bg-slate-900/40 backdrop-blur-sm">
              ...
              >
                <div className="bg-red-500 text-white px-6 py-2 flex items-center justify-between font-black text-[10px] uppercase tracking-widest">
                  ...
                  <button
                    onClick={() => setShowTransportSlip(false)}
                    className="hover:scale-110 transition-transform flex items-center gap-1 bg-white/20 px-2 py-0.5 rounded"
                  >
                    CLOSE
                  </button>
                </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-lg font-black uppercase text-blue-900">
                        {selectedSupplier?.name ||
                          "VARSHNEY ALOK SUIT PVT. LTD."}
                      </p>
                    </div>

                    <div className="grid grid-cols-1 gap-2 text-xs font-bold font-sans uppercase">
                      <div className="flex justify-between items-center italic">
                        <span>TS Entry No:</span>{" "}
                        <span className="text-blue-600">13</span>
                      </div>
                      <div className="flex justify-between items-center italic">
                        <span>TS Entry Date:</span> <span>15/Apr/2026</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span>BILTY NO:</span>{" "}
                        <span className="font-black">06457522</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span>BILTY DATE:</span> <span>11/Apr/2026</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span>FREIGHT:</span>{" "}
                      ...
                      <div className="flex justify-between items-center">
                        <span>BALES:</span> <span>1</span>
                      </div>
                      <div className="flex justify-between items-center italic">
                        <span>Private Marka:</span> <span>521</span>
                      </div>
                    </div>
        ...
        <div className="space-y-6 no-print">
          ...
          <div className="bg-primary p-10 rounded-[3rem] text-white shadow-2xl shadow-primary/20">
            <h4 className="font-serif text-2xl font-bold italic">
              Procurement Insight
            </h4>
            <p className="text-white/40 text-[10px] font-black uppercase tracking-widest mt-6">
              Active Suppliers
            </p>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-slate-900/60 backdrop-blur-md">
            ...
            >
              <div className="p-8 bg-slate-50 border-b border-slate-100 flex items-center justify-between">
                <div>
                  <h4 className="font-black text-slate-800 uppercase tracking-tight text-xl">
                    Material Inward Log
                  </h4>
                  <p className="text-[10px] text-slate-400 font-bold uppercase mt-1">
                ...
                <button
                  ...
                  className="w-12 h-12 flex items-center justify-center bg-white rounded-full text-slate-300 hover:text-red-500 shadow-sm border border-slate-100 transition-all"
                >
                  <X size={24} />
                </button>
              </div>
              ...
              <form
                ...
                className="p-8 space-y-8 h-[75vh] overflow-y-auto"
              >
                {/* Section: Header Info */}
                <div className="grid grid-cols-4 gap-4">
                  <div className="space-y-1">
                    ...
                    <input
                      name="entryType"
                      defaultValue="Purchase Bill"
                      className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:ring-4 focus:ring-primary/5 font-black text-xs uppercase"
                    />
                  </div>
                  <div className="space-y-1">
                    <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest pl-1">
                  ...
                  <div className="space-y-1">
                    ...
                    <input
                      name="billDate"
                      type="date"
                      className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:ring-4 focus:ring-primary/5 font-black text-xs"
                    />
                  </div>
                  <div className="space-y-1">
                    <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest pl-1">
                ...
                <div className="space-y-4">
                  <p className="text-[10px] font-black text-primary uppercase tracking-[0.2em] border-b border-primary/10 pb-2">
                    Supplier Registry
                  </p>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1">
                      ...
                      <select
                        name="supplierId"
                        required
                        className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:ring-4 focus:ring-primary/5 font-bold text-xs appearance-none"
                      >
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        name="gstForm"
                        defaultValue="GST PURCHASE {OUT-STATE}"
                        className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:ring-4 focus:ring-primary/5 font-bold text-xs uppercase"
                      />
                    </div>
                  </div>
                ...
                {/* Section: Logistics */}
                <div className="space-y-4">
                  <p className="text-[10px] font-black text-blue-600 uppercase tracking-[0.2em] border-b border-blue-100 pb-2">
                    Logistics & Handling
                  </p>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1">
                ...
                <div className="space-y-4">
                  <p className="text-[10px] font-black text-emerald-600 uppercase tracking-[0.2em] border-b border-emerald-100 pb-2">
                    Item Specifications
                  </p>
                  <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-1">
                      ...
                      <select
                        name="productId"
                        required
                        className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl outline-none focus:ring-4 focus:ring-primary/5 font-bold text-xs appearance-none cursor-pointer"
                      >
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        <div className="space-y-1">
                          ...
                          <input
                            name="brand"
                            className="w-full px-3 py-2 bg-slate-50 border border-slate-100 rounded-lg text-xs uppercase"
                          />
                        </div>
                        <div className="space-y-1">
                          <label className="text-[8px] font-black text-slate-400 uppercase pl-1">
                ...
                <div className="space-y-4 bg-slate-900 p-8 rounded-3xl text-white">
                  <p className="text-[10px] font-black text-primary uppercase tracking-[0.2em] border-b border-white/10 pb-2">
                    Financial Accounting
                  </p>
                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-1">
                      <label className="text-[9px] font-black text-white/30 uppercase tracking-widest pl-1">
                        Total Valuation
                      </label>
                      <input
                        name="amount"
                        ...
                        required
                        placeholder="0.00"
                        className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl outline-none focus:border-primary/50 font-black text-sm text-blue-300"
                      />
                    </div>
                    <div className="grid grid-cols-2 gap-2">
                      <div className="space-y-1">
                        <label className="text-[8px] font-black text-white/30 uppercase pl-1">
                          CGST
                        </label>
                        <input
                          name="cgst"
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="space-y-1">
                      ...
                      <input
                        name="rdAmount"
                        type="number"
                        className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl outline-none text-xs"
                      />
                    </div>
                    <div className="space-y-1">
                      <label className="text-[9px] font-black text-white/30 uppercase tracking-widest pl-1">
                ...
                <div className="flex gap-4 pt-4">
                  <button
                    type="submit"
                    className="flex-1 py-5 bg-primary text-white font-black rounded-2xl shadow-xl shadow-primary/30 hover:scale-[1.02] active:scale-[0.98] transition-all uppercase tracking-widest text-[10px]"
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => setIsModalOpen(false)}
                    className="px-10 py-5 bg-slate-100 text-slate-400 font-black rounded-2xl uppercase tracking-widest text-[10px] hover:bg-slate-200 transition-all"
                  >
                    Cancel
                  </button>
                </div>
            ...
            >
              <div className="p-6 bg-blue-600 text-white flex justify-between items-center">
                <div>
                  ...
                  <p className="text-white/60 text-[8px] font-bold uppercase mt-0.5">
                    LR #{showTransportSlip}
                  </p>
                </div>
                <button
              ...
              <div className="p-8">
                {state.transportLogs.find(
                  (l) => l.lrNo === showTransportSlip,
                ) ? (
                  <div className="space-y-6 no-print">
                    {(() => {
                      const log = state.transportLogs.find(
                        (l) => l.lrNo === showTransportSlip,
                      )!;
                      return (
                        <>
                          <div className="grid grid-cols-2 gap-6 pb-6 border-b border-slate-50 text-[10px]">
                            <div>
                              <p className="text-slate-400 font-black uppercase tracking-widest leading-none mb-1">
                                Transporter
                              </p>
                            ...
                            <div>
                              ...
                              <p className="font-black text-slate-800 uppercase tabular-nums">
                                {log.vehicleNo || "N/A"}
                              </p>
                            </div>
                          </div>
                          <div className="grid grid-cols-2 gap-6 text-[10px]">
                            <div>
                              ...
                              <p className="font-black text-emerald-600 text-lg tabular-nums">
                                ₹{log.freightAmount.toLocaleString()}
                              </p>
                            </div>
                            <div>
                              <p className="text-slate-400 font-black uppercase tracking-widest leading-none mb-1">
                  ...
                  <div className="py-12 text-center space-y-4">
                    ...
                    <p className="text-[10px] text-slate-400 font-black uppercase tracking-widest leading-relaxed">
                      System cannot locate LR Record #{showTransportSlip} in
                      active logistics database.
                    </p>
                  </div>
                )}
              </div>
          ...
          <div className="fixed inset-0 z-[70] flex items-center justify-center p-6 bg-slate-900/60 backdrop-blur-md">
            ...
            >
              <div className="flex items-center justify-between mb-8">
                ...
                <button
                  onClick={() => setIsQuickSupplierModal(false)}
              ...
              >
                ...
                <button
                  type="submit"
                  className="w-full py-4 bg-primary text-white font-black rounded-xl uppercase tracking-widest text-[10px] mt-2"
                >
                  Add to Registry
                </button>
              </form>
